...
public class ParamMeta
{
    ...
    /// </summary>
    public ParamCalcCorrectDef CalcCorrectDef { get; set; }

    /// <summary>
    /// Provides a set of fields the define a CalcCorrectGraph for soul cost
    /// </summary>
    public ParamSoulCostDef SoulCostDef { get; set; }
    ...
    public void XmlDeserialize(string path, PARAMDEF def)
    {
        ...
        else
        {
            ...
            if (self != null)
            {
                ...
                if (CCD != null)
                {
                    CalcCorrectDef = new ParamCalcCorrectDef(this, CCD.InnerText);
                }

                XmlAttribute SCD = self.Attributes["SoulCostDef"];
                if (SCD != null)
                {
                    SoulCostDef = new ParamSoulCostDef(this, SCD.InnerText);
                }
            }
