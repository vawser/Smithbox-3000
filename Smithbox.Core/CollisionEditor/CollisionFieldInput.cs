...
public class CollisionFieldInput
{
    private Project Project;
    private CollisionEditor Editor;

    public CollisionFieldInput(Project curProject, CollisionEditor editor)
    {
        Project = curProject;
        Editor = editor;
    }
    ...
    {
        var inputWidth = CFG.Current.CollisionFieldInputWidth;
