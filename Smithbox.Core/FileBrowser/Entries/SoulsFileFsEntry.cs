...
{
    public static SoulsFileFsEntry? TryGetFor(Project ownerProject, string fileName, Func<Memory<byte>> getDataFunc, VirtualFileSystem? vfs = null, string? path = null)
    {
    ...
    /// <returns></returns>
    public static Func<Memory<byte>>? FindBhd(Project ownerProject, string fileName, VirtualFileSystem vfs, string path)
    {
